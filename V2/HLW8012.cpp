...
HLW8012 1.0.0
---
Copyright (C) 2016 by Xose Perez <xose.perez@gmail.com>
...
// TODO
String HLW8012::getInfo()
{
    return "CPW: " + (String)_current_pulse_width + "\nVPW: " + (String)_voltage_pulse_width + "\nPPW: " + (String)_power_pulse_width + "\n";
}
...
unsigned long HLW8012::getEnergy() {
    ...
    E = P*t = m*N  (E=energy)
    */
    return _pulse_count * _power_multiplier / 1000000.0 / 2;
